...
VCF_HEADER_ENTRIES = {
    ...
    'MOTIF_POS|HIGH_I_I_POS|MOTIF_SCORE_CHANGE|TRANSCRIPTION_FACTORS|NearestExonJB|'
    ...
    VcfInfo.CPSR_CSQ: {
        ...
        'Description': (
            ...
            'gnomADe_SAS_AF|CLIN_SIG|SOMATIC|PHENO|CHECK_REF|MOTIF_NAME|MOTIF_POS|HIGH_I_I_POS|'
