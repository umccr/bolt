...
| ---     | ---                                 | ---                            |
| pcgr    | ghcr.io/scwatts/bolt:0.2.18-pcgr    | • `bolt smlv_germline report`<br />• `bolt smlv_somatic annotate`<br />• `bolt smlv_somatic report`<br /> |
| gpgr    | ghcr.io/scwatts/bolt:0.2.18-gpgr    | • `bolt other cancer_report`   |
| snpeff  | ghcr.io/scwatts/bolt:0.2.18-snpeff  | • `bolt sv_somatic annotate`   |
| circos  | ghcr.io/scwatts/bolt:0.2.18-circos  | • `bolt other purple_baf_plot` |
| multiqc | ghcr.io/scwatts/bolt:0.2.18-multiqc | • `bolt other multiqc_report`  |
| base    | ghcr.io/scwatts/bolt:0.2.18         | • `bolt smlv_germline prepare`<br />• `bolt smlv_somatic rescue`<br />• `bolt smlv_somatic filter`<br />• `bolt sv_somatic prioritise`<br /> |
...
```bash
docker run -ti -v $(pwd):$(pwd) -w $(pwd) ghcr.io/scwatts/bolt:0.2.18 \
